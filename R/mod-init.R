...
#' @export
init_covid_netjail <- function(x, param, init, control, s) {
  ...
  dat <- init_status_covid_netjail(dat)

  ## Get initial prevalence
  dat <- prevalence_covid_netjail(dat, at = 1)
...
init_status_covid_netjail <- function(dat) {
